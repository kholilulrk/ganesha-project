...
func SetupRouter(r *gin.Engine) {
	...
	api := r.Group("/api")
	{
		...
		protected.DELETE("/sph/:id", controllers.DeleteSph)
			...
			protected.GET("/attendance/today", controllers.GetTodayAttendance)
			protected.POST("/attendance/hadir", controllers.AttendanceHadir)
			protected.POST("/attendance/tidak-hadir", controllers.AttendanceTidakHadir)
			protected.POST("/attendance/lembur/start", controllers.AttendanceLemburStart)
			protected.POST("/attendance/lembur/end", controllers.AttendanceLemburEnd)
			protected.GET("/attendance/report", controllers.GetAttendanceReport)
			protected.PUT("/attendance/:id", controllers.UpdateAttendanceRecord)
			protected.DELETE("/attendance/:id", controllers.DeleteAttendanceRecord)
