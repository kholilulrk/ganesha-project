...
func ConnectDatabase() error {
	...
	if err := db.AutoMigrate(&User{}, &Job{}, &TaskChecklist{}, &Permission{}, &JobDocument{}, &JobVerification{}, &Comment{}, &Surat{}, &Document{}, &Todo{}, &CalendarEvent{}, &Sph{}, &SphTeknisi{}, &ActivityLog{}, &AppSetting{}, &Notification{}, &FCMToken{}, &Vendor{}, &PaymentTerm{}, &Announcement{}, &Attendance{}); err != nil {
		return err
	}
