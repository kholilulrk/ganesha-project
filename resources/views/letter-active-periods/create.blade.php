    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <form x-data="{
                ...
                }" method="POST" action="{{ route('letter-active-periods.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input id="start_aktif" type="date" name="start_aktif" value="{{ old('start_aktif') }}" x-model="startAktif"
                    ...
                    <div>
                        ...
                        <select id="jenis_surat" name="jenis_surat" x-model="jenisSurat"
                            ...
                            <option value="SIK" {{ old('jenis_surat') === 'SIK' ? 'selected' : '' }}>SIK</option>
                            <option value="SC" {{ old('jenis_surat') === 'SC' ? 'selected' : '' }}>SC</option>
                        </select>
